...
<div class="not-prose text-white stroke-white">
  <div class="mt-2">
    <a href={tweetURL.toString()} rel="noopener noreferrer">
      <Button class="text-xl"
        ><span
          class="iconify prime--twitter text-xl align-text-bottom"
          aria-label="X"
        ></span><IconText>&nbsp;でシェア</IconText></Button
      >
    </a>
  </div>
  <div class="mt-2">
    <a href={lineURL.toString()} rel="noopener noreferrer">
      <Button class="text-xl"
        ><span
          class="iconify jam--line text-xl align-text-bottom"
          aria-label="X"
        ></span><IconText>&nbsp;でシェア</IconText></Button
      >
    </a>
  ...
  <div class="mt-2">
    <Button class="text-xl" on:click={onClickShare}
      ><span class="iconify ion--share text-xl align-text-bottom"
      ></span><IconText>&nbsp;シェア</IconText></Button
    >
  </div>
</div>
